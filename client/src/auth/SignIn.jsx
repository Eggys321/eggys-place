    ...
    <>
      <main>
        ...
        <form className="flex flex-col gap-y-4" onSubmit={handleSubmit(onSubmit)}>
          ...
          <MyButton type="submit" text={btnText} className="w-full h-[40px] font-[500] text-[20px] " disabled={isSubmitting} />
        </form>
        <p className="py-4">
          <span className="text-[15px] font-[400] text-[#FBFBFB] ">Don&apos;t have an account?</span>{" "}
          <button
            type="button"
