    ...
    <>
      <main>
        ...
        <form className="flex flex-col gap-y-4" onSubmit={handleSubmit(onSubmit)}>
          ...
          <MyButton type="submit" disabled={isSubmitting} text={btnText} className={`w-full h-[40px] font-[500] text-[20px] ${isSubmitting ? "bg-dark" : "bg-[#B67B0F]"} `} />
        </form>
        <p className="py-4">
          <span className="text-[15px] font-[400] text-[#FBFBFB] ">Already have an account?</span>{" "}
          <button
            type="button"
            className="text-[#B67B0F] font-[700] text-[16px] cursor-pointer ps-0.5 bg-transparent border-0"
